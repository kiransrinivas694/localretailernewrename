...
import 'package:store_app_b2b/widget/billed_tab_new.dart';

class TomorrowDeliveryTab extends StatefulWidget {
  const TomorrowDeliveryTab({super.key});

  @override
  State<TomorrowDeliveryTab> createState() => _TomorrowDeliveryTabState();
}

class _TomorrowDeliveryTabState extends State<TomorrowDeliveryTab>
      ...
      return Container(
        ...
        child: cartController.isLaterDeliveryLoading
            ...
            : cartController.laterDeliveryData.isEmpty
                ...
                ? Center(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: CommonText(
                            content: "Tomorrow Delivery Items not Available",
                            textColor: Colors.black,
                            boldNess: FontWeight.w500,
                ...
                //             children: [
                //               BilledTab(
                //                 items: cartController.laterDeliveryData[0]
                        ...
                        children: [
                          ListView.separated(
                            itemCount: cartController
                                .laterDeliveryData[0].storeVo[0].items.length,
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index) {
                              Item item = cartController
                                  .laterDeliveryData[0].storeVo[0].items[index];
