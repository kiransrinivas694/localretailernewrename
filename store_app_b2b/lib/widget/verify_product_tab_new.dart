...
class VerifyProductTab extends StatelessWidget {
  VerifyProductTab({
    Key? key,
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          CommonText(
                                            content:
                                                "₹${num.parse(cartController.cartListModel?.storeVo[index].totalPriceByStoreWithGst!.toStringAsFixed(2) ?? "0").round().toStringAsFixed(2)}",
                                            boldNess: FontWeight.w600,
                                            textColor: Colors.black,
                                          )
                                        ],
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          CommonText(
                            content:
                                "Total : ${cartController.cartListModel?.totalPriceWithGst != null ? num.parse(cartController.cartListModel?.totalPriceWithGst!.toStringAsFixed(2) ?? "0.00").round().toStringAsFixed(2) : 0.00}",
                            textSize: width * 0.035,
                            textColor: ColorsConst.textColor,
                          )
                        ],
