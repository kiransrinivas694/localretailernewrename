...
class NrLinkedRetailerTab extends StatelessWidget {
  NrLinkedRetailerTab({super.key});
        ...
        child: Column(
          children: [
              ...
              child: Obx(
                () => CommonSearchField(
                  ...
                  showCloseIcon: controller
                      .showSuffixForLinkedREtailerSearchController.value,
                  closeOnTap: () {
                    controller.linkedRetailerSearchController.text = "";
                    controller.networkRetailerLinkedListCurrentPage.value = 0;
                    controller.networkRetailerLinkedListPageSize.value = 10;
                    controller.networkRetailerLinkedListTotalPages.value = 0;
                    controller.getLinkedNetworkRetailerList(searchText: "");

                    controller.showSuffixForLinkedREtailerSearchController
                        .value = false;
                  },
                  controller: controller.linkedRetailerSearchController,
                  onChanged: (String value) {
                    controller.networkRetailerLinkedListCurrentPage.value = 0;
                    controller.networkRetailerLinkedListPageSize.value = 10;
                    controller.networkRetailerLinkedListTotalPages.value = 0;
                    controller.getLinkedNetworkRetailerList(searchText: value);
                    controller.showSuffixForLinkedREtailerSearchController
            ...
            Expanded(
              child: Container(
                child: Obx(
                  () => controller.isNetworkRetailerLinkedListLoading.value
                      ? Center(
                          child: CircularProgressIndicator(),
                        )
                      : controller.networkRetailerLinkedList.isEmpty
                          ? Center(
                              child: CommonText(
                                content: "No Linked Retailer Found",
                          ...
                          : NotificationListener<ScrollNotification>(
                              onNotification: (notification) {
                                if (notification is ScrollEndNotification &&
                                  ...
                                  if (controller
                                          .isNetworkRetailerLinkedListLoading
                                          .value ||
                                      controller
                                          .isNetworkRetailerMoreLinkedListLoading
                                          .value) {
                                    return false;
                                  }
                                  ...
                                  controller.getLinkedNetworkRetailerList(
                                    ...
                                    searchText: controller
                                        .linkedRetailerSearchController.text,
                                  );
                                }
                                return false;
                              },
                              child: ListView.separated(
                                itemCount:
                                    controller.networkRetailerLinkedList.length,
                                padding: EdgeInsets.symmetric(
                                    horizontal: 3, vertical: 3),
                                itemBuilder: (context, index) {
                                  NetworkRetailerSingleItem supplier =
                                      controller
                                          .networkRetailerLinkedList[index];
