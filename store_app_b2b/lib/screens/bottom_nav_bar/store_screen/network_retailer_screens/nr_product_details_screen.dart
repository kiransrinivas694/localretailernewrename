...
import 'package:store_app_b2b/model/product_details_model.dart';
import 'package:store_app_b2b/service/api_service.dart';
import 'package:store_app_b2b/utils/color_extension.dart';
import 'package:store_app_b2b/utils/shar_preferences.dart';
import 'package:store_app_b2b/widget/time_check.dart';

class NrProductDetailsScreen extends StatefulWidget {
  ...
  @override
  State<NrProductDetailsScreen> createState() => _NrProductDetailsScreenState();
}

class _NrProductDetailsScreenState extends State<NrProductDetailsScreen>
    with SingleTickerProviderStateMixin {
  ProductDetailsModel? productDetailsModel;
  final CarouselController _carouselController = CarouselController();
  TabController? tabController;

  final NrBuyController buyController = Get.put(NrBuyController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<NrBuyController>(
      init: NrBuyController(),
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if (buyController.qtyList[widget.index].value == 0) {
                          ...
                          //   setState(() {});
                          // });
                          final cartController = Get.put(NrCartController());
...
//
  addProductTextField(
      {required NrBuyController controller,
      required int index,
