...
import 'package:store_app_b2b/model/search_products_model.dart';
import 'package:store_app_b2b/screens/bottom_nav_bar/store_screen/network_retailer_screens/nr_product_details_screen.dart';
...
class NrBuyProductTab extends StatefulWidget {
  final String categoryId;
  final String? storeId;
  NrBuyProductTab({Key? key, required this.categoryId, this.storeId})
      : super(key: key);

  @override
  State<NrBuyProductTab> createState() => _NrBuyProductTabState();
}

class _NrBuyProductTabState extends State<NrBuyProductTab> {
  final controller = Get.find<NrBuyController>();
            ...
            Column(
              children: [
                ...
                controller.byProductList.isNotEmpty
                    ? Expanded(
                        child: GetBuilder(
                          builder: (NrBuyController controller) {
