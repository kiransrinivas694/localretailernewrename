...
import 'package:store_app_b2b/controllers/bottom_controller/store_controller/network_retailer/nr_order_history_controller_new.dart';
...
class NrByDateOrderHistoryTab extends StatelessWidget {
  NrByDateOrderHistoryTab({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
    return GetBuilder<NrOrderHistoryController>(
      builder: (NrOrderHistoryController controller) {
        return Column(
          children: [
            Container(
              color: Colors.white,
