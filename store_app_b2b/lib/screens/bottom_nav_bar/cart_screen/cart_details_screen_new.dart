                                                                ...
                                                                if (widget
                                                                                              ...
                                                                                              child: ElevatedButton(
                                                                                                ...
                                                                                                onPressed: () async {
                                                                                                  ...
                                                                                                  if (widget.cartController.userId.value.isNotEmpty) {
                                                                                                    ...
                                                                                                    dynamic response = await widget.cartController.getQtyPlushAddToCartApi(bodyMap);

                                                                                                    print("response of update qty -> $response");

                                                                                                    if (response is Map<String, dynamic> && response.containsKey("status") && response["status"] == false && response.containsKey("message") && response["message"] != null && response["message"].isNotEmpty) {
                                                                                                      CommonSnackBar.showError(response["message"]);
                                                                  ...
                                                                  if (widget
                                                                    ...
                                                                    dynamic
                                                                        ...
                                                                        await widget
                                                                            .cartController
                                                                            .getQtyPlushAddToCartApi(bodyMap);

                                                                    print(
                                                                        "response of update qty 1 -> $response");
                                                            ...
                                                            if (widget
                                                              ...
                                                              if (widget
                                                                                            ...
                                                                                            child: ElevatedButton(
                                                                                              ...
                                                                                              onPressed: () async {
                                                                                                ...
                                                                                                if (widget.cartController.userId.value.isNotEmpty) {
                                                                                                  ...
                                                                                                  print("response of update qty 2 -> $response");
                                                                ...
                                                                if (widget
                                                                  ...
                                                                  print(
                                                                      "response of update qty 3-> $response");
                                      ...
                                      children: [
                                        ...
                                        CommonText(
                                          content:
                                              ...
                                              "₹${num.parse(cartController.cartListModel?.storeVo[widget.storeIndex].totalPriceByStoreWithGst!.toStringAsFixed(2) ?? "0").round().toStringAsFixed(2)}",
                                          textSize: width * 0.048,
                                          textColor: Colors.black,
                                          boldNess: FontWeight.w600,
                                        ),
